...
def map_base()->Map:
    ...
    # list_1 = [1,2,3]
    # list_2 = ['a','b','c']
    # c = [list(z) for z in zip(list_1, list_2)]
    # print(c)
    # output: [[1, 'a'], [2, 'b'], [3, 'c']]
    c = (
            Map()
...
# 06. 全国疫情概览
def currnumber_base():
    cur = {'conf':'20280','suspect':222020,'dead':100,'cure':102011}
    return cur
...
def index():
    content = table_base()
    cur = currnumber_base()
    return render_template("index.html", content=content, currnumber=cur)
